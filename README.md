...
D-BIS is primarily developed using Python for data processing, analysis, anomaly detection, and analytical workflows.
...
The primary Python libraries used or applicable to the analytical workflow include:
